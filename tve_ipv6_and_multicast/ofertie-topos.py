...
class ComplexIPv6( Topo ):
	...
	self.addLink( secondSwitch, secondHost, 4, 2)
	self.addLink( thirdSwitch, secondHost, 2, 3)
	self.addLink( fourthSwitch, secondHost, 3, 1)
...
class TwoRoutes( Topo ):
    "Two hosts with two routes inbetween"
    ...
    def __init__( self ):
        ...
        self.addLink( firstHost, firstSwitch, 1, 1 )
        self.addLink( firstSwitch, secondSwitch, 2, 1 )
        self.addLink( firstSwitch, thirdSwitch, 3, 1 )
        self.addLink( secondSwitch, secondHost, 2, 1 )
