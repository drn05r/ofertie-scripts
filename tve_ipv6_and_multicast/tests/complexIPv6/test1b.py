...
class ComplexIPv6Test1b( unittest.TestCase ):
    ...
    def test1b( self ): 
        print >> sys.stderr, "Test 1b: Testing flow modifications using eth_type=0x86dd"
	...
	results_folder = os.path.normpath(os.path.join( self.basepath, 'results', self.topology, "test1b" ))
