...
class ComplexIPv6Test2b( unittest.TestCase ):
    ...
    def test2b( self ):
        print >> sys.stderr, "Test 2b: Testing flow modifications using ipv6_src and ipv6_dst"
	...
	Oftutils.expectline( network, "s2 dpctl unix:/tmp/s2 meter-mod cmd=add,flags=1,meter=10 drop:rate=5000");
        ...
        results_folder = os.path.normpath(os.path.join( self.basepath, 'results', self.topology, "test2b" ))
